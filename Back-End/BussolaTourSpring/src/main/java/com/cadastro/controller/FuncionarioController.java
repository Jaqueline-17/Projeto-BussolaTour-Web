...
public class FuncionarioController {
	...
	@GetMapping("{id}")
	public ResponseEntity<Funcionario> selecionarFuncionario(@PathVariable("id_funcionario") long FuncionarioId){
	...
	@PutMapping("{id}")
	public ResponseEntity<Funcionario> atualizarFuncionario(@PathVariable("id_funcionario") long id, @RequestBody Funcionario funcionario){
		return new ResponseEntity<Funcionario>(service.atualizarFuncionario(funcionario, id), HttpStatus.OK);
	}
	
	@DeleteMapping("{id}")
	public ResponseEntity<String> deletarFuncionario(@PathVariable("id_funcionario") long id){
