...
public class PacoteController {
	...
	@GetMapping("{id}")
	public ResponseEntity<Pacote> selecionarCliente(@PathVariable("id_pcaote") long PacoteId){
	...
	@PutMapping("{id}")
	public ResponseEntity<Pacote> atualizarPacote(@PathVariable("id_pcaote") long id, @RequestBody Pacote pacote){
		return new ResponseEntity<Pacote>(service.atualizarPacote(pacote, id), HttpStatus.OK);
	}
	
	@DeleteMapping("{id}")
	public ResponseEntity<String> deletarPacote(@PathVariable("id_pcaote") long id){
