...
public class ClienteController {
	...
	@GetMapping("{id}")
	public ResponseEntity<Cliente> selecionarCliente(@PathVariable("id_cliente") long ClienteId){
	...
	@PutMapping("{id}")
	public ResponseEntity<Cliente> atualizarCliente(@PathVariable("id_cliente") long id, @RequestBody Cliente cliente){
		return new ResponseEntity<Cliente>(service.atualizarCliente(cliente, id), HttpStatus.OK);
	}
	
	@DeleteMapping("{id}")
	public ResponseEntity<String> deletarCliente(@PathVariable("id_cliente") long id){
